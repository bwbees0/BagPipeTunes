...
\include "/home/ben/workspace/GitHub_BagPipeTunes/APB-Gr4-2018-Tunes/LilyPond/Grade_4_Medley_Set_2018_Voices-Part-B.ly"


filename = "~/APB-Gr4-2018-Medley-Part-B.ly"
...
\header { 
          title = "APB 2018 Grade 4 Medley Part B"
          composer = ""
          arranger = ""
          meter = "" 
...
\book {
  % \bookOutputSuffix 
  \bookOutputName "APB-2018-Gr4-Medley-Part-B"   
  \score {
	\new GrandStaff <<
		\new Staff = "GHB" <<
			\new Voice {
